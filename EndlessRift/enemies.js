        ...
        if (safeHouse.active) {
            ...
            if (distToSafeHouseCenter < safeZoneOuterBoundary) {
                if (distToSafeHouseCenter === 0) {
                    ...
                    nextY = Math.sin(angleFromSafeHouseCenter) * safeZoneOuterBoundary; // Typo fix: should be nextY = safeHouse.y + ...
                    nextY = safeHouse.y + Math.sin(angleFromSafeHouseCenter) * safeZoneOuterBoundary; // Corrected line
                }
            }
        }
