...
const UPGRADE_POOL = [
    ...
    { id: "impact", title: "Greater Impact", maxLevel: Infinity, description: (level) => `Increase projectile size by 25%. (Lvl ${level + 1})`, apply: (p) => { p.weapon.size.h *= 1.25; } },
    ...
    },
    {
        ...
        maxLevel: Infinity,
        skill: "soulVortex",
        description: (level) => `Gain an additional orbiting soul. (Total: ${player.abilities.orbitingShield.count + 1})`,
        apply: (p) => {
...
function getAiMovementVector() {
    ...
    if (closestTotem && (!player.skills[closestTotem.skill].isUnlocked || (player.abilities.orbitingShield.enabled && closestTotem.skill === 'soulVortex'))) target = closestTotem;
