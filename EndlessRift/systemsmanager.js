...
const UPGRADE_POOL = [
    ...
    { id: "greed", title: "Greed", maxLevel 5, description: (level) => `Increase XP pickup radius by 50%. (Lvl ${level + 1})`, apply: (p) => { p.pickupRadius *= 1.50; } },
    ...
    { id: "lightning_chains", title: "Lightning: Chain Lightning", maxLevel: 20, skill: "lightning", description: (level) => `Lightning chains to ${level + 2} enemies.`, apply: (p) => { p.skills.lightning.chains += 1; } },
    ...
    { id: "lightning_fork", title: "Lightning: Fork", maxLevel: 3, skill: "lightning", description: () => `Each lightning strike has a chance to fork.`, apply: (p) => { p.skills.lightning.forkChance = (p.skills.lightning.forkChance || 0) + 0.15; } },
    ...
    { id: "volcano_duration", title: "Volcano: Scorched Earth", maxLevel: 5, skill: "volcano", description: () => `Burning ground lasts longer.`, apply: (p) => { p.skills.volcano.burnDuration *= 1.3; } },
    { id: "volcano_count", title: "Volcano: Cluster Bombs", maxLevel: 5, skill: "volcano", description: () => `Volcano creates an extra eruption.`, apply: (p) => { p.skills.volcano.count = (p.skills.volcano.count || 1) + 1; } },
    ...
    { id: "frostnova_slow", title: "Frost Nova: Crippling Cold", maxLevel: 20, skill: "frostNova", description: () => `Frost Nova's slow is more effective.`, apply: (p) => { p.skills.frostNova.slowAmount += 0.1; } },
    ...
    { id: "blackhole_pull", title: "Black Hole: Gravity Well", maxLevel: 20, skill: "blackHole", description: () => `Black Hole's pull is stronger.`, apply: (p) => { p.skills.blackHole.pullStrength *= 1.5; } },
    ...
    { id: "bulletstorm_firerate", title: "Bulletstorm: Rapid Fire", maxLevel: 30, skill: "bulletstorm", description: () => `Bulletstorm fires faster.`, apply: (p) => { p.skills.bulletstorm.fireRate *= 0.8; } },
